    ...
    <>
      <nav className={`navbar${scrolled ? ' scrolled' : ''}`} id="navbar">
        <div className="nav-inner">
          ...
          <button className={`hamburger${menuOpen ? ' open' : ''}`} onClick={() => setMenuOpen(!menuOpen)} aria-label="Abrir menú">
      ...
      <div className={`mobile-menu${menuOpen ? ' open' : ''}`} id="mobileMenu">
        ...
        <a href="tel:+528112345678" onClick={closeMenu}>(81) 1234-5678</a>
      </div>
      ...
      <section className="hero" id="inicio">
        ...
        <div className="hero-content">
          <div className="hero-badge">Empresa constructora certificada</div>
          <h1>Construimos<br />proyectos que<br />conectan con<br /><span>el futuro</span></h1>
          <p className="hero-sub">Desarrollamos proyectos industriales, comerciales y urbanos con calidad, puntualidad y compromiso en cada etapa.</p>
        ...
        <div className="about-inner">
          ...
          <div className="fade-up">
            ...
            <div className="about-feats">
              <div className="about-feat">Certificación ISO 9001</div>
              <div className="about-feat">Proyectos llave en mano</div>
              <div className="about-feat">Equipo propio de maquinaria</div>
              <div className="about-feat">Asesoría integral</div>
            </div>
      ...
      <section className="numbers">
        <div className="numbers-grid">
          {[
            ...
            <div className="number-item fade-up" key={num}>
          ...
          {services.map((service) => (
            <div className="service-card fade-up" key={service.num}>
              ...
              <div className="service-card-body">
                ...
                <h3>{service.title}</h3>
                <p>{service.text}</p>
                <a href="#" className="service-link">Conoce más</a>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="process">
        ...
        <div className="process-grid">
          {[
            ...
            <div className="process-card fade-up" key={num}>
        ...
        <div className="contact-inner">
          <div className="contact-info fade-up">
            ...
            <div className="contact-details">
              <ContactDetail label="Teléfono" value="(81) 1234-5678" icon="phone" />
          ...
          <div className="contact-form fade-up">
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <input type="tel" placeholder="(81) 0000-0000" />
              </div>
            </div>
            <div className="form-group">
            ...
            <button className="form-submit" onClick={() => alert('¡Mensaje enviado! Nos pondremos en contacto pronto.')}>Enviar mensaje</button>
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        <div className="footer-top">
          ...
          <div className="footer-col">
            <h4>Contacto</h4>
            <ul>
              <li><a href="tel:+528112345678">(81) 1234-5678</a></li>
              <li><a href="mailto:contacto@edifica.mx">contacto@edifica.mx</a></li>
              <li><a href="#">Av. Constitución 450</a></li>
              <li><a href="#">Monterrey, N.L.</a></li>
            </ul>
          </div>
        </div>
      ...
      <a href="https://wa.me/528112345678" target="_blank" rel="noreferrer" className="wa-btn" title="Escríbenos por WhatsApp">
